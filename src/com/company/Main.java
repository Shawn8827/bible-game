...
public class Main extends JPanel implements KeyListener {
    ...
    public ImageIcon deathIcon = new ImageIcon("death.png");
    Moses moses;
    private int level;
            ...
            case KeyEvent.VK_UP:
                ...
                if (mosesPoint.y > 1) {
                    ...
                    if (result.equals("Die")) {
                        //reset game
                        level = 1;
                        JOptionPane.showMessageDialog(this, "You die, plz try again !", "No !!!!", JOptionPane.ERROR_MESSAGE, deathIcon);
                        resetGame(new DisasterView());
                        return;
                    }
                ...
                for (int i = mosesPoint.y; i >= 0; i--) {
                    for (Sprite s : gameView.getElements()) {
                        if (s.getRelativePosition() != null && s.getRelativePosition().x == mosesPoint.x && s.getRelativePosition().y == i) {
                            ...
                            if (s instanceof Bug || s instanceof Frog || s instanceof Anubis || s instanceof Pharaoh) {
                                s.setNullPosition();
                                repaint();
                                return;
                            }
